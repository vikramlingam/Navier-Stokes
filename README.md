...
2. ns.jpeg: A 3D illustration showing vortex stretching and the inward spiral effect.
3. vortex_blowup.gif: An animated simulation showing a swirl squeezing inward while water speed spikes toward a singularity.

How to run:
Open navier_stokes_beginner_demo.ipynb in Jupyter Notebook, VS Code, or Google Colab, and run the cells from top to bottom.
